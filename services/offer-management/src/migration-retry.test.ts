...
describe("offer-management storage recovers from a migration that fails at boot", () => {
  it("becomes ready after a retry, without a process restart", async () => {
    ...
    await within(migrations.applied(), "offer-management storage never became ready after retrying");
...
describe("offer-management probes while migrations are still being retried", () => {
