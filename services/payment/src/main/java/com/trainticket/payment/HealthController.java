...
import com.trainticket.payment.infrastructure.persistence.PaymentReadiness;
...
public class HealthController {
    ...
    private final PaymentReadiness readiness;

    public HealthController() {
        this(Clock.systemUTC(), new PaymentReadiness(java.util.Optional.empty()));
    }

    public HealthController(PaymentReadiness readiness) {
        this(Clock.systemUTC(), readiness);
    }

    HealthController(Clock clock) {
        this(clock, new PaymentReadiness(java.util.Optional.empty()));
    }

    HealthController(Clock clock, PaymentReadiness readiness) {
        this.clock = clock;
