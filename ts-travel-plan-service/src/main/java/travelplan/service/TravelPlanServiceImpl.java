...
public class TravelPlanServiceImpl implements TravelPlanService {
  ...
  public Response getCheapest(TripInfo info, HttpHeaders headers) {
    ...
    ArrayList<RoutePlanResultUnit> routePlanResultUnits =
        getRoutePlanResultCheapest(routePlanInfo, headers);
    ...
    if (!routePlanResultUnits.isEmpty()) {
      ...
      TravelPlanServiceImpl.LOGGER.warn(
          "[getCheapest][Get cheapest trip warn][Route Plan Result Units: {}]", "No Content");
  ...
  public Response getQuickest(TripInfo info, HttpHeaders headers) {
    ...
    routePlanInfo.setTravelDate(info.getDepartureTime());
    ArrayList<RoutePlanResultUnit> routePlanResultUnits =
        getRoutePlanResultQuickest(routePlanInfo, headers);
    ...
    if (!routePlanResultUnits.isEmpty()) {
      ...
      TravelPlanServiceImpl.LOGGER.warn(
          "[getQuickest][Get quickest trip warn][Route Plan Result Units: {}]", "No Content");
      return new Response<>(0, cannotFind, null);
    }
  }
  ...
  public Response getMinStation(TripInfo info, HttpHeaders headers) {
    ...
    routePlanInfo.setTravelDate(info.getDepartureTime());
    ArrayList<RoutePlanResultUnit> routePlanResultUnits =
        getRoutePlanResultMinStation(routePlanInfo, headers);
    ...
    if (!routePlanResultUnits.isEmpty()) {
      ...
      TravelPlanServiceImpl.LOGGER.warn(
          "[getMinStation][Get min stations trip warn][Route Plan Result Units: {}]", "No Content");
      return new Response<>(0, cannotFind, null);
    }
  }
  ...
  private int getRestTicketNumber(
    ...
    TravelPlanServiceImpl.LOGGER.info(
        "[getRestTicketNumber][Seat Request][Seat Request is: {}]", seatRequest.toString());
  ...
  private ArrayList<RoutePlanResultUnit> getRoutePlanResultCheapest(
      RoutePlanInfo info, HttpHeaders headers) {
    HttpEntity requestEntity = new HttpEntity(info, headers);
    String routePlanServiceUrl = getServiceUrl("ts-route-plan-service");
    ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re =
        restTemplate.exchange(
            routePlanServiceUrl + "/api/v1/routeplanservice/routePlan/cheapestRoute",
            HttpMethod.POST,
            requestEntity,
  ...
  private ArrayList<RoutePlanResultUnit> getRoutePlanResultQuickest(
      RoutePlanInfo info, HttpHeaders headers) {
    HttpEntity requestEntity = new HttpEntity(info, headers);
    String routePlanServiceUrl = getServiceUrl("ts-route-plan-service");
    ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re =
        restTemplate.exchange(
            routePlanServiceUrl + "/api/v1/routeplanservice/routePlan/quickestRoute",
            HttpMethod.POST,
            requestEntity,
            new ParameterizedTypeReference<Response<ArrayList<RoutePlanResultUnit>>>() {});
  ...
  private ArrayList<RoutePlanResultUnit> getRoutePlanResultMinStation(
      RoutePlanInfo info, HttpHeaders headers) {
    HttpEntity requestEntity = new HttpEntity(info, headers);
    String routePlanServiceUrl = getServiceUrl("ts-route-plan-service");
    ResponseEntity<Response<ArrayList<RoutePlanResultUnit>>> re =
        restTemplate.exchange(
            routePlanServiceUrl + "/api/v1/routeplanservice/routePlan/minStopStations",
            HttpMethod.POST,
            requestEntity,
            new ParameterizedTypeReference<Response<ArrayList<RoutePlanResultUnit>>>() {});
    return re.getBody().getData();
  ...
  private List<TripResponse> tripsFromHighSpeed(TripInfo info, HttpHeaders headers) {
    ...
    ResponseEntity<Response<List<TripResponse>>> re =
        restTemplate.exchange(
            travelServiceUrl + "/api/v1/travelservice/trips/left",
            HttpMethod.POST,
            requestEntity,
  ...
  private ArrayList<TripResponse> tripsFromNormal(TripInfo info, HttpHeaders headers) {
    ...
    ResponseEntity<Response<ArrayList<TripResponse>>> re =
        restTemplate.exchange(
            travel2ServiceUrl + "/api/v1/travel2service/trips/left",
            HttpMethod.POST,
            requestEntity,
