...
public interface OrderRepository extends JpaRepository<Order, String> {
  ...
  ArrayList<Order> findByAccountIdAndTrainNumberAndTravelDate(
      String accountId, String trainNumber, String travelDate);
  ...
  @Query(
      "SELECT COUNT(o) FROM Order o WHERE o.accountId = :accountId AND o.boughtDate > :boughtDate")
  int countOrdersAfterTime(
      @Param("accountId") String accountId, @Param("boughtDate") String boughtDate);

  @Query("SELECT COUNT(o) FROM Order o WHERE o.accountId = :accountId AND o.status IN :statuses")
  int countOrdersByAccountIdAndStatusIn(
      @Param("accountId") String accountId, @Param("statuses") List<Integer> statuses);

  // Method for sold tickets aggregation
  @Query(
      "SELECT o.seatClass, COUNT(o) FROM Order o "
