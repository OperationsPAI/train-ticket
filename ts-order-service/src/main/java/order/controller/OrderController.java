...
public class OrderController {
    ...
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message for the Order Service")
    public String home() {
    ...
    @Operation(summary = "Get sold tickets", description = "Get list of sold tickets by date and trip")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Admin create order", description = "Create a new order with admin privileges")
    @CrossOrigin(origins = "*")
    ...
    @Operation(summary = "Refresh orders query", description = "Query orders for refresh with updated status")
    @CrossOrigin(origins = "*")
    ...
    @Operation(summary = "Calculate sold tickets", description = "Get sold tickets count by date and train number")
    @CrossOrigin(origins = "*")
    ...
    @Operation(summary = "Security check", description = "Check security information about orders for an account")
    @CrossOrigin(origins = "*")
