...
public class WaitListOrder {
  ...
  public Date getCreatedTime() {
    return StringUtils.String2Date(createdTime);
  }
  ...
  public Date getWaitUtilTime() {
    return StringUtils.String2Date(waitUtilTime);
  }
  ...
  public void setTravelTime(Date travelTime) {
    this.createdTime = StringUtils.Date2String(travelTime);
  }

  public void setWaitUntilTime(Date waitUntilTime) {
    this.waitUtilTime = StringUtils.Date2String(waitUntilTime);
  }
}
