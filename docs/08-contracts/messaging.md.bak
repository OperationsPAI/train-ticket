...
```
XADD events:payment 1720000000000-0 envelope "{\"eventId\":\"evt_pay_cap_20260703_a1b2c3d4\",\"eventType\":\"PaymentCaptured\",\"eventVersion\":1,\"source\":\"payment\",\"correlationId\":\"corr_journey_order_42\",\"causationId\":\"evt_pay_int_20260703_x1y2z3\",\"occurredAt\":\"2026-07-03T10:30:00.000Z\",\"payload\":{\"paymentId\":\"pay_98765\",\"paymentIntentId\":\"pi_12345\",\"journeyOrderId\":\"jo_42\",\"amount\":{\"currency\":\"CNY\",\"units\":35000,\"cents\":0},\"capturedAt\":\"2026-07-03T10:30:00.000Z\",\"channel\":\"wechat_pay\"},\"metadata\":{\"traceId\":\"trace_abc123\",\"tenantId\":\"default\"}}"
```
...
```json
{
  "eventId": "evt_pay_cap_20260703_a1b2c3d4",
  "eventType": "PaymentCaptured",
  "eventVersion": 1,
  "source": "payment",
  "correlationId": "corr_journey_order_42",
  "causationId": "evt_pay_int_20260703_x1y2z3",
  "occurredAt": "2026-07-03T10:30:00.000Z",
  "payload": {
    "paymentId": "pay_98765",
    "paymentIntentId": "pi_12345",
    "journeyOrderId": "jo_42",
    "amount": {
      "currency": "CNY",
      "units": 35000,
      "cents": 0
    },
    "capturedAt": "2026-07-03T10:30:00.000Z",
    "channel": "wechat_pay"
  },
  "metadata": {
...
interface EventPublisher {
     ...
     *                  source, correlationId, causationId, occurredAt, payload,
     *                  metadata).
     *
     * Behavior:
...
Startup:
  for each required stream:
    XGROUP CREATE events:<stream> <group> $ MKSTREAM   (ignore "BUSYGROUP" error)
